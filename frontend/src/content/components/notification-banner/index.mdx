...
<Example component="notification-banner" html="./examples/default.html" astro="./examples/default.astro" react="./examples/default.react.tsx" svelte="./examples/default.svelte" solid="./examples/default.solid.tsx" />

## Success

Use the success variant to confirm that something the user has done has been successful.

<Example component="notification-banner" html="./examples/success.html" astro="./examples/success.astro" react="./examples/success.react.tsx" svelte="./examples/success.svelte" solid="./examples/success.solid.tsx" />
