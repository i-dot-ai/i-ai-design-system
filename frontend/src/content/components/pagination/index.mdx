...
A default pagination helps users navigate collections of numbered pages.

<Example component="pagination" html="./examples/default.html" astro="./examples/default.astro" react="./examples/default.react.tsx" svelte="./examples/default.svelte" solid="./examples/default.solid.tsx" />
