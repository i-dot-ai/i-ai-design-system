...
To create users for your app, you'll need to add them to our Auth API deployment. The documentation for that can be found in the [core-auth-api](https://github.com/i-dot-ai/core-auth-api/) repo. Access can be provided at either the username (i.e. email address) or domain level.
